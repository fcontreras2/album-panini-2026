// stickers.js — full 980-sticker album data
// Auto-converted from src/data/stickers.ts (do not edit by hand; regenerate from the source)

window.ALBUM_DATA = (function () {
// ─── INTRO STICKERS (9) ──────────────────────────────────────────────────────
const introStickers = [
...
function team(code, teamName, players) {
...
const stickerMap = Object.fromEntries(
  ...
  return { introStickers, teamSections, historyStickers, allStickers, stickerMap };
})();

// ─── GROUPS — World Cup 2026 (12 groups × 4 teams) ──────────────────
window.GROUPS = {
  A: ["MEX","RSA","KOR","CZE"], B: ["CAN","BIH","QAT","SUI"],
  C: ["BRA","MAR","HAI","SCO"], D: ["TUR","JPN","GER","IRN"],
  E: ["KSA","NED","IRQ","JOR"], F: ["UZB","SWE","BEL","AUS"],
  G: ["ESP","CIV","TUN","PAR"], H: ["ECU","EGY","CPV","URU"],
  I: ["ARG","SEN","FRA","NOR"], J: ["AUT","POR","ALG","CUW"],
  K: ["PAN","COD","ENG","CRO"], L: ["USA","COL","GHA","NZL"],
};
window.TEAM_TO_GROUP = (function () {
  const m = {};
...
window.GROUP_ORDER = ["A","B","C","D","E","F","G","H","I","J","K","L"];
